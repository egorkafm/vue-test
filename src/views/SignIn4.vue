<template>
  <div class="container">
    <div class="header__content">
      ...
      <div class="header__login">Do not have an account? 
    ...
    <div class="form__main">
      <div class="form__content">
        ...
        <form action="#" method="POST">
          <!-- <input class="form__imp" type="password" placeholder="New password"/>
          <input class="form__imp" type="password" placeholder="Confirm password"/> -->
          <CustomInput type="password" placeholder="New password"/>
          <CustomInput type="password" placeholder="Confirm password"/>
        </form><br/><br/>
        <button class="form__btn">Reset</button>
      </div>
    </div>
  </div>
</template>
...
import CustomButton from '../components/controllers/button';
...
export default {
  ...
  beforeCreate() {
    apiService.get('/SignIn4')
      .then((res) => {
        console.log(res);
        this.SignIn4 = res.data.SignIn4
      })
      .catch((err) => {
        console.log(err);
      })
